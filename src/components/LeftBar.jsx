import { Box, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Paper, CardActionArea, CardHeader, Avatar, Switch, FormGroup, FormControlLabel, styled } from "@mui/material";
        ...
        <Paper flex={1} sx={{ mb: 2 }}>
          <List>
            ...
            <ListItem disablePadding>
              <FormGroup>
                <FormControlLabel 
                  control={<MaterialUISwitch onChange={e => setMode(mode === "light" ? "dark" : "light")} sx={{ ml: 2, mr: 0.5 }} />}
                  label="Theme"
                />
              </FormGroup>
            </ListItem>
